...
namespace FuseeApp
{
    ...
    [FuseeApplication(Name = "BugRotatedPicking", Description = "Yet another FUSEE App.")]
    public class BugRotatedPicking : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            _rocketScene = AssetStorage.Get<SceneContainer>("rotatedcube.fus");
